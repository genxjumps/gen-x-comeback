...
This verifies the publication identity for that deployment. Controlled participant
email/browser tests were still unperformed at that checkpoint. Public intake remained closed in
the published source. No secrets, operational gates, or database schema were changed during
publication. The earlier executor HTTP 403 recorded during migration did not recur in the
production verifier; it retrieved and verified the live identity.
