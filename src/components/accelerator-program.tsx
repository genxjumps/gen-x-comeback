          ...
          {hub.progress.programCompleted ? (
            ...
            <section className="rounded-lg border border-border bg-gxj-mint p-6">
              ...
              <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                {`Day ${hub.progress.currentDay} opens ${friendlyDate(hub.progress.availableOn)}.`}
              </p>
        ...
        <aside className="space-y-4">
          <section className="rounded-lg border border-border bg-card p-4">
            <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-muted-foreground">
              Week {selectedDay?.week ?? displayWeek} Coaching
            </p>
            <h2 className="mt-1 text-lg font-semibold">
              {hub.snapshot.weekFocus.find(
                ({ week }) => week === (selectedDay?.week ?? displayWeek),
              )?.title ?? focus.title}
            </h2>
